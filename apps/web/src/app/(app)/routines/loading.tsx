      ...
      <section className="min-h-0 flex-1 overflow-hidden rounded-lg border border-border/70 bg-card/80 shadow-sm md:rounded-2xl">
        <Tabs defaultValue="my" className="min-h-0 flex-1">
          <TabsList aria-label="Routine library">
            <TabsTrigger value="global" disabled>Global Routines</TabsTrigger>
            <TabsTrigger value="my" disabled>My Routines</TabsTrigger>
          </TabsList>
        </Tabs>
        <div className="flex justify-end border-b border-border/70 bg-background/30 p-1"><Skeleton className="h-9 w-64" /></div>
